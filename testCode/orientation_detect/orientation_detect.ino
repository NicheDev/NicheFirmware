...
void loop()
{
  ...
  if(dataRead & 0x20) Serial.print("device is looking up!   "); //Serial.print("Z high    "); // we need this 
  
//  if(dataRead & 0x10) Serial.print("Z low   ");
//  if(dataRead & 0x08) Serial.print("Y high    ");
//  if(dataRead & 0x04) Serial.print("Y low   ");
//  if(dataRead & 0x02) Serial.print("X high    ");
//  if(dataRead & 0x01) Serial.print("X low   ");
